(function ($) {
    ...
    $('.hero-slider-two').slick({
        ...
        slidesToScroll: 1,
        autoplay: true,
        prevArrow: '<span class="arrow-prv">قبل</span>',
        nextArrow: '<span class="arrow-next">بعد</span>',
        responsive: [
            {
                breakpoint: 1199,
                settings: {
    ...
    $('[data-countdown]').each(function () {
        ...
        $this.countdown(finalDate, function (event) {
            $this.html(event.strftime('<div class="single-countdown"><span class="single-countdown__time">%S</span><span class="single-countdown__text">ثانیه</span></div><div class="single-countdown"><span class="single-countdown__time">%M</span><span class="single-countdown__text">دقیقه</span></div><div class="single-countdown"><span class="single-countdown__time">%H</span><span class="single-countdown__text">ساعت</span></div><div class="single-countdown"><span class="single-countdown__time">%D</span><span class="single-countdown__text">روز</span></div>'));
        });
    });
